...
<div class="space-y-6">
  <div>
    <h3 class="text-lg font-medium text-gray-900 mb-3">Enter Additional Labor Hours</h3>
    <p class="text-gray-500 mb-4">Record any <strong>additional</strong> labor hours not included in the original job quote. These hours will be added to the final invoice.</p>
