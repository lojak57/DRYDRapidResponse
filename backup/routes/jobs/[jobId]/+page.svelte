      ...
      <div class="p-6 bg-gray-50">
        ...
        <div class="mt-6">
          ...
          {:else}
            ...
            {#if $currentUser?.role === Role.TECH && $currentJob && ($currentJob.status === JobStatus.NEW || $currentJob.status === JobStatus.SCHEDULED || $currentJob.status === JobStatus.IN_PROGRESS)}
