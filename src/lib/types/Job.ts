...
export interface Job {
  ...
  /** Flag indicating if the job is in insurance mode */
  insuranceMode?: boolean;
  /** URL to the signed authorization document */
  signedAuthUrl?: string;
  /** Generated claim narrative text */
  claimNarrative?: string;
  /** URL to the generated insurance document package */
  insurancePackageUrl?: string;
} 